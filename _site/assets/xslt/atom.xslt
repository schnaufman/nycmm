...
<!--	<script src="https://ajax.googleapis.com/ajax/libs/webfont/1.5.18/webfont.js"></script>
	<script>
		WebFont.load({
			google: {
				families: [ 'Lato:300,300italic:latin,400,400italic:latin', 'Volkhov::latin' ]
			}
		});
	</script>-->

	<noscript>
		<link href="https://fonts.googleapis.com/css?family=Lato:300,300i,400,400i,700|Volkhov" rel="stylesheet">
	</noscript>
	...
	<meta property="og:site_name" content="NYC Musikmarathon Mattighofen">
...
<div id="navigation" class="sticky">
  <nav class="top-bar" role="navigation" data-topbar>
    <ul class="title-area">
      <li class="name">
      <h1 class="show-for-small-only"><a href="http://localhost:4000" class="icon-tree"> NYC Musikmarathon Mattighofen</a></h1>
    </li>
